...
<section class="content">
    <div class="container-fluid">
        <div class="alert alert-info text-center" role="alert">
            ...
            Selecciona un cliente de la lista para poder ingresar un pago del mismo.
        </div>
...
$(document).ready(function() { //Espera a que el documento este listo
    $(".seleccionar").click(function(evento) { //selecciono el td que tenga de nombre de clase "editar"
        ...
        Notiflix.Confirm.show(
            'Aviso',
            'Estas por ingresar un pago de ' + nombre.html() +
            '',
            'Si',
            'No',
            function Si() {
                location.href = ('?Seccion=pago&hash=' + id_producto.html());
            },
            function No() {
                return;
            },
