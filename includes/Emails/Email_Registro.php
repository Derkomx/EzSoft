							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										...
										Acabas de registrarte en Ge Soft
								...
								<tr>
									...
									<div class="mktEditable" id="download_button" style="text-align: center;">
										<a href="http://ezsoft.hopto.org/EzSoft/?Token=<?php echo $activacion; ?>">
							...
							<table>
								<tr>
									<td align="center" style="font-family: Arial, sans-serif; -webkit-text-size-adjust: none; font-size: 16px;">
											...
											<br/><span style="font-size:12x; font-family: Arial, sans-serif; -webkit-text-size-adjust: none; color: #61955B;" >En caso de que el botón no funcione, copie y pegue el siguiente enlace en su navegador: </br>http://ezsoft.hopto.org/EzSoft/?Token=<?php echo $activacion; ?></span>
